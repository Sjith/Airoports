...
/**
 * Show list of time table airports from the file/ static data
 */
public class AiroportsDataActivity extends ListActivity {
	...
	public static Intent buildIntent(Context context) {
		return new Intent(context, AiroportsDataActivity.class);
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (!item.isSectionItem()) {
			...
			data.putExtra(SearchTimeTableActivity.FROM_AIROPORT,
					airoport.getName());
			setResult(SearchTimeTableActivity.TABLE_RESULT, data);
			finish();
		}
	...
	private static class AiroportsLoader
			extends
			ProgressAsyncTask<String, Void, List<AiroportItem>, AiroportsDataActivity> {

		public AiroportsLoader(AiroportsDataActivity target,
		...
		@Override
		protected List<AiroportItem> doInBackground(AiroportsDataActivity target,
				String... params) {
			List<AiroportItem> saveAiroports = Lists.newArrayList();
			
			Map<String, String> airoports = AiroportsTableUtils.getAiroports();
			for (String key : airoports.keySet()) {
				saveAiroports.add(new Airoport(key));
			}
		...
		@Override
		protected void onPostExecute(AiroportsDataActivity target,
		...
		private void setAdapterToListview(AiroportsDataActivity target,
